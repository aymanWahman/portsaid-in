...
const hotels: DataTypes[] = [
  {
    ...
    region: "حي الشرق",
    address:
      "Port Said, Atef El-Sadat Street Madînet, Portsaid, Port Said Governorate 42511",
    contact: "0663267550",
    description:
      "فندق فاخر يوفر إقامة مميزة مع إطلالة على البحر وخدمات عالية الجودة.",
  ...
  },
  {
    ...
    contact: "0663332211",
    description:
      "فندق يقدم خدمات راقية بأسعار تناسب الجميع، مناسب للعائلات ورجال الأعمال.",
  ...
  },
  {
    ...
    contact: "0663200511",
    description:
      "فندق يقدم خدمات إقامة بسيطة ومناسبة للعائلات مع موقع قريب من الحدائق والمرافق العامة.",
  ...
  },
  {
    ...
    contact: "01023337880",
    description:
      "فندق اقتصادي يوفر إقامة مريحة وخدمات أساسية مع إطلالة مباشرة على البحر.",
