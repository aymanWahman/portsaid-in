...
import hospital from "@/data/DataHospital";
// المكون يستقبل البيانات والترجمات كـ props
function HospitalClient({ translations }: { translations: Translations }) {
  ...
  const uniqueRegions = ["All", ...new Set(hospital.map((d) => (locale === 'ar' ? d.region : d.regionEn)))];
  const uniqueCategories = [
    "All",
    ...new Set(hospital.map((d) => (locale === 'ar' ? d.category : d.categoryEn))),
  ];
